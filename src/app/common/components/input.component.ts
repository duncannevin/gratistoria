...
export class InputComponent implements ControlValueAccessor {
  ...
  @Input() inputClass =
    'flex h-10 w-full rounded-md border-none bg-slate-100 px-3 py-2 ring-offset-background file:border-0 file:bg-transparent file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50';
